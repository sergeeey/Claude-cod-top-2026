...
| **branch** | `fix/sec-01-remove-code-runner-auto-allow` (commit `fd3a793`), branched off `main` @ `1160187` (PR #204 + PR #201 both merged). Not yet pushed/PR'd. |
| **last verified SHA** | `fd3a793` — full suite 2255 passed / 3 skipped / 2 xfailed, ruff clean, mypy clean (123 files). |
