...
## Recent findings
[summarized] [summarized] [summarized] [summarized] [summarized] - 2026-07-19 (later, this session): investigated the "~600/701 orpha...
...
## Recent findings
[summarized] [summarized] [summarized] [summarized] [summarized] [summarized] [summarized] [summarized] [summarized] - 2026-07-12: **...
...
## Current Focus
[summarized] [summarized] [summarized] [summarized] [summarized] [summarized] [summarized] [summarized] [summarized] **PR #171 MERGED...
...
## Auto-commit log
- [2026-07-30 09:38] `7f566da`: fix(readme): sync test count badge 2508 -> 2509 (CI-measured on this PR)
- [2026-07-30 09:34] `b51dbd6`: test(hooks): add regression guard for pattern_extractor.py canonical path
- [2026-07-30 09:20] `aa290c1`: fix(readme): sync test count badge 2500 -> 2508 (CI-measured on this PR)
- [2026-07-30 09:13] `c1b633b`: test(hooks): add regression guards for playbook.md/learning_log.md canonical path
- [2026-07-30 00:44] `a60885b`: test(install): add regression guards for patterns.md/learning_log.md canonical path
- [2026-07-30 00:15] `b963861`: fix(install): seed patterns.md/learning_log.md at canonical path, not _auto/
- [2026-07-29 23:19] `7553123`: fix(hooks): read/write playbook.md and learning_log.md at canonical paths
- [2026-07-29 21:05] `ef9b76e`: fix(hooks): read/write patterns.md at its documented canonical path
- [2026-07-29 18:55] `5bc4466`: docs(memory): record PR #239 merge + point at the two patterns written to raw/
- [2026-07-29 18:47] `622dde0`: docs(memory): record webhook hermeticity fix + retract the "7 failures" figure
- [2026-07-29 18:46] `26db911`: fix(tests): make webhook tests hermetic — 6 failed without DNS
- [2026-07-29 14:56] `2a57e94`: docs(memory): record webhook hermeticity refutation + global deploy
- [2026-07-29 14:52] `06d1f9e`: fix: version research-methodology.md, sync test badge 2489 -> 2500
- [2026-07-29 14:42] `86b890d`: docs: narrow HARB verdict scope, fix baseline metric statuses (external review)
- [2026-07-29 14:03] `bea11e1`: docs(memory): record methodology-outcomes ledger decision + first finding
- [2026-07-29 14:02] `42c3e92`: docs: start methodology-outcomes ledger (manual phase, no hook)
...
- [2026-07-28 22:23] `d97b7ee`: methodology: integrate canonical oracle adequacy gate into FL and hypothesis-arbiter
- [2026-07-28 22:23] `f77aa3c`: experiment: record null MCID result for hypothesis-arbiter taxonomy pilot
