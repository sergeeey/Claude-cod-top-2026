...
<p align="center">
  ...
  &nbsp;
  <img src="https://img.shields.io/badge/hooks-91_guards-00f5ff?style=flat-square" alt="Hooks"/>
  &nbsp;
  <img src="https://img.shields.io/badge/agents-13_%2B_3_teams-ff2d78?style=flat-square" alt="Agents"/>
  &nbsp;
  <img src="https://img.shields.io/badge/Tests-2331-00ff9f?style=flat-square" alt="Tests"/>
  &nbsp;
...
<p align="center">
  <sub>Backed by 91 hooks · 13 agents + 3 teams · 2331 tests · 80% coverage · MIT · Deploy in 5 min</sub>
</p>
...
| **Tests** | "I'll write them later" | 2331 tests, TDD-first, Test Protection hard rule |
...
|---|---|---|
| **Surface** | 48 agents · 182 skills · 68 commands · ~31 MB | 13 agents + 3 squads · 125 skills · 91 hooks · ~10 MB |
...
| **Daily Driver** | + 91 hooks + 13 agents + all 125 skills | 5 min | `--profile=standard` |
...
│   └── mentor-protocol.md
│
├── hooks/                         91 hooks + utils.py/hook_state.py/severity_calibrator.py (shared libs)
...
| [Hooks Guide](docs/hooks-guide.md) | All 91 hooks with examples |
...
<p align="center">
  ...
  &nbsp;&nbsp;
  <img src="https://img.shields.io/badge/91_hooks-always_on-ff2d78?style=for-the-badge&labelColor=02020f" alt="91 hooks always on"/>
</p>
