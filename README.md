...
<p align="center">
  ...
  &nbsp;
  <img src="https://img.shields.io/badge/hooks-96_guards-00f5ff?style=flat-square" alt="Hooks"/>
  &nbsp;
  <img src="https://img.shields.io/badge/agents-13_%2B_3_teams-ff2d78?style=flat-square" alt="Agents"/>
  &nbsp;
  <img src="https://img.shields.io/badge/Tests-2783-00ff9f?style=flat-square" alt="Tests"/>
  &nbsp;
  <img src="https://img.shields.io/badge/Coverage-82%25-00ff9f?style=flat-square" alt="Coverage" title="82% of included hooks/scripts; 28 files (CLI tools + global-env-dependent hooks) excluded by design"/>
  &nbsp;
...
<p align="center">
  <sub>Backed by 96 hooks · 13 agents + 3 teams · 2783 tests · 82% coverage · MIT · Deploy in 5 min</sub>
</p>
...
| **Daily Driver** | + 96 hooks + 13 agents + all 129 skills | 5 min | `--profile=standard` |
...
| **Tests** | "I'll write them later" | 2783 tests, TDD-first, Test Protection hard rule |
...
|---|---|---|
| **Surface** | 48 agents · 182 skills · 68 commands · ~31 MB | 13 agents + 3 squads · 129 skills · 96 hooks · ~10 MB |
...
│   └── mentor-protocol.md
│
├── hooks/                         96 hooks + utils.py/hook_state.py/severity_calibrator.py (shared libs)
...
| [Hooks Guide](docs/hooks-guide.md) | All 96 hooks with examples |
...
<p align="center">
  ...
  &nbsp;&nbsp;
  <img src="https://img.shields.io/badge/96_hooks-defined-ff2d78?style=for-the-badge&labelColor=02020f" alt="96 hooks defined" title="83 wired, 6 dormant, 6 internal library modules — see docs/hook-control-matrix.md"/>
</p>
