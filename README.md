...
<p align="center">
  ...
  &nbsp;
  <img src="https://img.shields.io/badge/Tests-2053-00ff9f?style=flat-square" alt="Tests"/>
  &nbsp;
...
| **Tests** | "I'll write them later" | 1730 tests, TDD-first, Test Protection hard rule |
...
|---|---|---|
| **Surface** | 48 agents · 182 skills · 68 commands · ~31 MB | 15 agents + 3 squads · 122 skills · 86 hooks · ~10 MB |
...
| **Daily Driver** | + 86 hooks + 15 agents + all 122 skills | 5 min | `--profile=standard` |
