...
<p align="center">
  ...
  &nbsp;
  <img src="https://img.shields.io/badge/Tests-2243-00ff9f?style=flat-square" alt="Tests"/>
  &nbsp;
...
<p align="center">
  <sub>Backed by 88 hooks · 13 agents + 3 teams · 2243 tests · 80% coverage · MIT · Deploy in 5 min</sub>
</p>
...
| **Tests** | "I'll write them later" | 2243 tests, TDD-first, Test Protection hard rule |
...
│   └── mentor-protocol.md
│
├── hooks/                         88 hooks + utils.py/hook_state.py/severity_calibrator.py (shared libs)
