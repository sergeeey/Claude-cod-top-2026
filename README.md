...
<p align="center">
  ...
  &nbsp;
  <img src="https://img.shields.io/badge/hooks-100_guards-00f5ff?style=flat-square" alt="Hooks"/>
  &nbsp;
  <img src="https://img.shields.io/badge/agents-13_%2B_3_teams-ff2d78?style=flat-square" alt="Agents"/>
  &nbsp;
  <img src="https://img.shields.io/badge/Tests-3607-00ff9f?style=flat-square" alt="Tests"/>
  &nbsp;
...
<p align="center">
  <sub>Backed by 100 hooks · 13 agents + 3 teams · 3607 tests · 85% coverage · MIT · Deploy in 5 min</sub>
</p>
...
| **Daily Driver** | + 100 hooks + 13 agents + all 135 skills | 5 min | `--profile=standard` |
...
| **Tests** | "I'll write them later" | 3607 tests, TDD-first, Test Protection hard rule, security-critical slice reported separately via `scripts/reliability_vector.py` (never averaged into the general pass rate) |
...
|---|---|---|
| **Surface** | 48 agents · 182 skills · 68 commands · ~31 MB | 13 agents + 3 squads · 135 skills · 100 hooks · ~10 MB |
...
│   └── mentor-protocol.md
│
├── hooks/                         100 hooks + utils.py/hook_state.py/severity_calibrator.py (shared libs)
...
| [Hooks Guide](docs/hooks-guide.md) | All 100 hooks with examples |
...
<p align="center">
  ...
  &nbsp;&nbsp;
  <img src="https://img.shields.io/badge/100_hooks-defined-ff2d78?style=for-the-badge&labelColor=02020f" alt="100 hooks defined" title="88 wired, 2 dormant, 6 internal library modules — see docs/hook-control-matrix.md"/>
</p>
