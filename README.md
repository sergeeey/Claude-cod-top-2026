...
<p align="center">
  ...
  &nbsp;
  <img src="https://img.shields.io/badge/Tests-3337-00ff9f?style=flat-square" alt="Tests"/>
  &nbsp;
...
<p align="center">
  <sub>Backed by 99 hooks · 13 agents + 3 teams · 3337 tests · 85% coverage · MIT · Deploy in 5 min</sub>
</p>
...
| **Tests** | "I'll write them later" | 3337 tests, TDD-first, Test Protection hard rule, security-critical slice reported separately via `scripts/reliability_vector.py` (never averaged into the general pass rate) |
