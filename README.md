...
<p align="center">
  ...
  &nbsp;
  <img src="https://img.shields.io/badge/Tests-3316-00ff9f?style=flat-square" alt="Tests"/>
  &nbsp;
...
<p align="center">
  <sub>Backed by 99 hooks · 13 agents + 3 teams · 3316 tests · 85% coverage · MIT · Deploy in 5 min</sub>
</p>
...
| **Daily Driver** | + 99 hooks + 13 agents + all 134 skills | 5 min | `--profile=standard` |
...
| **Tests** | "I'll write them later" | 3316 tests, TDD-first, Test Protection hard rule, security-critical slice reported separately via `scripts/reliability_vector.py` (never averaged into the general pass rate) |
...
|---|---|---|
| **Surface** | 48 agents · 182 skills · 68 commands · ~31 MB | 13 agents + 3 squads · 134 skills · 99 hooks · ~10 MB |
