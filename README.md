...
<p align="center">
  ...
  &nbsp;
  <img src="https://img.shields.io/badge/hooks-94_guards-00f5ff?style=flat-square" alt="Hooks"/>
  &nbsp;
...
<p align="center">
  <sub>Backed by 94 hooks · 13 agents + 3 teams · 2699 tests · 84% coverage · MIT · Deploy in 5 min</sub>
</p>
...
| **Daily Driver** | + 94 hooks + 13 agents + all 128 skills | 5 min | `--profile=standard` |
...
|---|---|---|
| **Surface** | 48 agents · 182 skills · 68 commands · ~31 MB | 13 agents + 3 squads · 128 skills · 94 hooks · ~10 MB |
...
│   └── mentor-protocol.md
│
├── hooks/                         94 hooks + utils.py/hook_state.py/severity_calibrator.py (shared libs)
...
| [Hooks Guide](docs/hooks-guide.md) | All 94 hooks with examples |
...
<p align="center">
  ...
  &nbsp;&nbsp;
  <img src="https://img.shields.io/badge/94_hooks-defined-ff2d78?style=for-the-badge&labelColor=02020f" alt="94 hooks defined" title="83 wired, 6 dormant, 6 internal library modules — see docs/hook-control-matrix.md"/>
</p>
