...
<p align="center">
  ...
  &nbsp;
  <img src="https://img.shields.io/badge/Tests-2508-00ff9f?style=flat-square" alt="Tests"/>
  &nbsp;
...
<p align="center">
  <sub>Backed by 95 hooks · 13 agents + 3 teams · 2508 tests · 80% coverage · MIT · Deploy in 5 min</sub>
</p>
...
| **Tests** | "I'll write them later" | 2508 tests, TDD-first, Test Protection hard rule |
...
│
├── rules/                         16 modular rules (loaded on demand)
│   ├── coding-style.md
│   ├── security.md
│   ├── testing.md
│   ├── integrity.md
