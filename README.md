...
<p align="center">
  ...
  &nbsp;
  <img src="https://img.shields.io/badge/Tests-3019-00ff9f?style=flat-square" alt="Tests"/>
  &nbsp;
...
<p align="center">
  <sub>Backed by 98 hooks · 13 agents + 3 teams · 3019 tests · 84% coverage · MIT · Deploy in 5 min</sub>
</p>
...
| **Tests** | "I'll write them later" | 3019 tests, TDD-first, Test Protection hard rule, security-critical slice reported separately via `scripts/reliability_vector.py` (never averaged into the general pass rate) |
