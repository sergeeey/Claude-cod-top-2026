...
<p align="center">
  ...
  &nbsp;
  <img src="https://img.shields.io/badge/Tests-1077-00ff9f?style=flat-square" alt="Tests"/>
  &nbsp;
...
| **Tests** | "I'll write them later" | 1077 tests, TDD-first, Test Protection hard rule |
...
pytest tests/ -v --cov=hooks --cov-report=term-missing   # 1077 tests
...
```
1077 passing · 0 failing · 86% coverage · 82/82 smoke tests
```
