...
<p align="center">
  ...
  &nbsp;
  <img src="https://img.shields.io/badge/Tests-2233-00ff9f?style=flat-square" alt="Tests"/>
  &nbsp;
...
<p align="center">
  <sub>Backed by 89 hooks · 15 agents + 3 teams · 2233 tests · 80% coverage · MIT · Deploy in 5 min</sub>
</p>
...
| **Tests** | "I'll write them later" | 2233 tests, TDD-first, Test Protection hard rule |
...
|---|---|---|
| **Surface** | 48 agents · 182 skills · 68 commands · ~31 MB | 15 agents + 3 squads · 125 skills · 89 hooks · ~10 MB |
...
| **Daily Driver** | + 89 hooks + 15 agents + all 125 skills | 5 min | `--profile=standard` |
...
│   └── mentor-protocol.md
│
├── hooks/                         89 hooks + utils.py (shared lib)
