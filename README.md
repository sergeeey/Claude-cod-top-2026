...
<p align="center">
  ...
  &nbsp;
  <img src="https://img.shields.io/badge/Tests-2408-00ff9f?style=flat-square" alt="Tests"/>
  &nbsp;
...
<p align="center">
  <sub>Backed by 94 hooks · 13 agents + 3 teams · 2408 tests · 80% coverage · MIT · Deploy in 5 min</sub>
</p>
...
| **Tests** | "I'll write them later" | 2408 tests, TDD-first, Test Protection hard rule |
...
|---|---|---|
| **Surface** | 48 agents · 182 skills · 68 commands · ~31 MB | 13 agents + 3 squads · 125 skills · 94 hooks · ~10 MB |
...
| **Daily Driver** | + 94 hooks + 13 agents + all 125 skills | 5 min | `--profile=standard` |
...
<p align="center">
  ...
  &nbsp;&nbsp;
  <img src="https://img.shields.io/badge/94_hooks-always_on-ff2d78?style=for-the-badge&labelColor=02020f" alt="94 hooks always on"/>
</p>
