...
<p align="center">
  ...
  &nbsp;
  <img src="https://img.shields.io/badge/Tests-972-00ff9f?style=flat-square" alt="Tests"/>
  &nbsp;
  <img src="https://img.shields.io/badge/Coverage-66%25-00ff9f?style=flat-square" alt="Coverage"/>
  &nbsp;
...
| **Tests** | "I'll write them later" | 972 tests, TDD-first, Test Protection hard rule |
...
pytest tests/ -v --cov=hooks --cov-report=term-missing   # 972 tests
...
```
972 passing · 0 failing · 66% coverage · 82/82 smoke tests
```
