...
TIPS: list[dict] = [
    ...
    # Level 2 — Productivity
    {
        ...
        "next_try": "Напиши 'test_' функцию первой, получи RED,"
        " потом попроси Claude сделать GREEN.",
    },
    {
        "id": "L2-T02",
        "level": 2,
    ...
    },
    {
        ...
        "next_try": "Прочти hooks/permission_policy.py и добавь паттерн"
        " который ты одобряешь каждый день.",
    },
]
