...
If you want the full enforcement system (56 hooks, 50 skills, blocking-mode VTG, audit verification gate, [×N] recurring-mistake counter, redact-secrets layer for telemetry logs):
