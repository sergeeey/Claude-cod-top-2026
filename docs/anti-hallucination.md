...
If you want the full enforcement system (85 hooks, 116 skills, blocking-mode VTG, audit verification gate, [×N] recurring-mistake counter, redact-secrets layer for telemetry logs):
