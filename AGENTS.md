...
This project is indexed by GitNexus as **Claude-cod-top-2026** (3189 symbols, 6997 relationships, 74 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
