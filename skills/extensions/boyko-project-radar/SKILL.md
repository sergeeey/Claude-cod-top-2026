...
> Перенесено из frontmatter `description:` 2026-09-10. Описание грузится в
> системный промпт КАЖДЫЙ ход; эта история нужна только когда скилл реально
> запускается. Текст ниже — дословно тот, что стоял в описании.
