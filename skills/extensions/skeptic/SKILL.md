---
name: skeptic
description: "Skeptic Engine v2.1 — falsification-first анализ в 4 режимах. Режим 1: сломай идею до того как она съест время и деньги ('skeptic:', 'сломай идею', 'стоит ли делать', 'проверь идею'). Режим 2: аудит архитектуры и техрешений ('аудит архитектуры', 'проверь решение', 'red-team архитектуры'). Режим 3: разбор экспериментов, метрик и claims ('разбор эксперимента', 'проверь метрики', 'это работает?', 'проверь claim'). Режим 4: дебаг решений и инцидентов без магического мышления ('дебаг', 'что пошло не так', 'разбери инцидент', 'почему сломалось')."
