...
description: >
  ...
  поиска новых гипотез (/sci-hypothesis), стратегического планирования с нуля (/research-strategist)
effort: high
tokens: ~1500
---
...
- `/skeptic` — атаковать конкретный claim (не всю программу)
...
- `/research-strategist` — стратегическое планирование ПОСЛЕ аудита
- `/validate-blind` — слепая валидация конкретного claim без знания истории
