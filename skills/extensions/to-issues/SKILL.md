...
Скил   : to-issues
TL;DR  : Разбивает план, спек или PRD на независимо-захватываемые GitHub issues через tracer-bullet вертикальные слайсы — каждый slice дemoable/verifiable сам по себе.
Вызов  : /to-issues, convert plan to issues, create implementation tickets, break down work into issues
НЕ для : Задачи уже в трекере, планирование без GitHub Issues, оперативные bugfix
-->
