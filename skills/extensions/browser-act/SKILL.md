---
name: browser-act
description: "Автоматизация браузера для ИИ-агентов: stealth без детекции, решение капчи, параллельные сессии. Использовать когда нужно взаимодействовать с сайтами — навигация, заполнение форм, клики, скриншоты, извлечение данных, скрейпинг с bot-detection."
